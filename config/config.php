...
//  $teamscore=mysqli_fetch_array(mysqli_query($dbconn, "SELECT ServerID, Score FROM ".$sqlprefix."teamscores".$suffix." WHERE `TeamID`='".SWID."'"));
	$dogtags=mysqli_fetch_array(mysqli_query($dbconn, "SELECT SUM(".$sqlprefix."dogtags".$suffix.".Count) FROM ".$sqlprefix."dogtags".$suffix." INNER JOIN ".$sqlprefix."server_player".$suffix." ON ".$sqlprefix."dogtags".$suffix.".KillerID=".$sqlprefix."server_player".$suffix.".PlayerID AND ".$sqlprefix."server_player".$suffix.".ServerID = '".SWID."'"));
